function [M_best E_best] = ParticleFilterD(F,P,Sim)
...
while Sim.conv==false;
    ...
    if Sim.Mstep
        ...
        P    = M_step(Sim,S,M,P,F);         % update parameters
        fprintf('\n\nIteration #%g, lik=%g, dlik=%g',i,P.lik,P.lik-Eold.lik)
