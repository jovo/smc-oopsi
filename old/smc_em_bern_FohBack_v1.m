function S = smc_em_bern_FohBack_v1(Sim,R,B)
...
% backward sampler is "proper", in that the variances are as derived, and
% are particle has its own, because spike histories make the p_k a function
% of the particle.
% 
%% inputs: 
