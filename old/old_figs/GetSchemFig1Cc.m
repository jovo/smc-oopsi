function GetSchemFig1Cc(Sim,R,S,B,M)
...
h=fill([Sim.tvec Sim.tvec(ind)],[M.Ibar-sqrt(M.Ivar) M.Ibar(ind)+sqrt(M.Ivar(ind))],ccol(1,:));
set(h,'edgecolor',ccol(1,:))
plot(Sim.tvec,M.Ibar,'linewidth',2,'color',col(1,:))
