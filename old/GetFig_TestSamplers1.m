function GetFig_TestSamplers1(Sim,R,S,M)
...
for i=1:2
    ...
    if i==1,                                                                        %top left plot
        ...
        ylab=ylabel({'2^k-component'; 'Sampler'});
    ...
    if i==2,                                                                        %top right plot
        ...
        cla, hold on
        ylab=ylabel({'k-component';'Sampler'});
...
plot(M(1).Cbar+cmax,'r','linewidth',2),     
plot(Oind,O+cmax,'.k','LineWidth',1,'markersize',7)      %plot observations

plot(S{2}.C'), 
plot(R.C,'k','linewidth',2), 
plot(M(2).Cbar,'r','linewidth',2)
plot(Oind,O,'.k','LineWidth',1,'markersize',7)      %plot observations
...
print -depsc C:\D\Research\liam\SMC_EM_GLM\bernoulli\test