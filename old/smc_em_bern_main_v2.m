function [B, S, M, E] = smc_em_bern_main_v2(Sim,R,P)
...
%         elseif pf==2
%             S = smc_em_bern_FohBack_v4d(Sim,R,B);
        else
            Sim.van = true;
        ...
        %% backward step
        S.w_b = smc_em_bern_backwardPF_v4(Sim,S,B);

        %% get moments and mse's
        M(pf,iter) = smc_em_bern_moments_v1(Sim,S,R);
